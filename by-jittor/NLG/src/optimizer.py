...
class CosineAnnealingWarmupRestarts(jt.optim.LRScheduler):
    """
...
class CyclicScheduler(jt.optim.LRScheduler):
    def __init__(
        self,
        optimizer,
        interval_steps = [],
...
def get_linear_schedule_with_warmup(
    ...
    return jt.optim.LambdaLR(optimizer, lr_lambda, last_epoch)
